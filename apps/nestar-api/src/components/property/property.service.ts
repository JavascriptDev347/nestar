...
export class PropertyService {
  ...
  public async getProperty(
    ...
    // Agar memberId bo'lsa propertyViewni bittaga oshirish
    if (memberId) {
      const viewInput = {
        memberId: memberId,
  ...
  public async updateProperty(memberId: ObjectId, input: PropertyUpdate) {
  ...
  public async getAllPropertiesByAdmin(input: AllPropertiesInquiry) {
  ...
  public async updatePropertyByAdmin(input: PropertyUpdate): Promise<Property> {
    let { soldAt, deleteAt, propertyStatus } = input;
    const search: T = {
      _id: input._id,
      propertyStatus: PropertyStatus.ACTIVE,
    };
  ...
  public async likeTargetProperty(
    ...
    // Like toggle
    const modifier = await this.likeService
      .toggleLike(input);
